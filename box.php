	...
	protected function html_options() {
		...
		return array_merge($html, array(
			...
			'updated_post_date_intro' => array(
				...
				'tooltip' => sprintf(__('Any text you supply here will be wrapped in %s, like so:<br /><code>&lt;span class="updated_post_date_intro"&gt</code>your text<code>&lt;/span&gt;</code>.', $this->_class), $thesis->api->base['html'])))
			);
	}
